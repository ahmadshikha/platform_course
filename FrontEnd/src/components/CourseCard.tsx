...
export default function CourseCard({ course, onEdit, onDelete }: CourseCardProps) {
  ...
  return (
    <div onClick={()=> navigate(`/course-details/${course._id}`)} className="bg-white rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-shadow duration-200">
      <div className="p-6">
        {/* Header */}
